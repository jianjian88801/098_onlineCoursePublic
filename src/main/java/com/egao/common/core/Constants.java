...
public class Constants {
    /* 文件服务器配置 */
    public static final String UPLOAD_DIR = "E:\\educationProject\\在线教育系统\\onlineCourse\\";  // 上传的目录

    //public static final String UPLOAD_DIR = File.listRoots()[0] + "E:\\educationProject\\在线教育系统\\onlineCourse\\file";  // 上传的目录
